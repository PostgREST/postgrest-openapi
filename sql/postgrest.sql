...
select
  coalesce(
    (postgrest_unfold_comment(description))[1],
  'PostgREST API') as title,
  (postgrest_unfold_comment(
    (postgrest_unfold_comment(description))[2])
  )[1] as summary,
  coalesce(
      (postgrest_unfold_comment(
        (postgrest_unfold_comment(description))[2])
      )[2],
  'This is a dynamic API generated by PostgREST') as description  
from
  pg_namespace n
